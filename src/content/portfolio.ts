...
export const techStackGroups = [
  {
    label: "Programming",
    skills: ["Python", "SQL", "C", "Java", "HTML", "CSS", "JavaScript",  "TypeScript",
  "React", "Next.js", "Tailwind CSS", "Expo"],
  },
  {
    label: "Tools",
  ...
  {
    label: "Learning",
    skills: ["Data Engineering","Data Science", "Computer Vision","Machine Learning", "Agile"],
  },
];
...
export const education = [
  {
    title: "PSHS Graduate",
    meta: "STEM Course • Philippine Science High School Western Visayas Campus • 2018-2024",
    href: "",
  },
  {
    title: "Bachelor of Science in Computer Science",
    meta: "Degree • University of the Philippines Visayas • 2024 - 2028",
    href: "https://www.upv.edu.ph/",
  },
];
