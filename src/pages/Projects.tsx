    ...
    <section className="pt-10">
      ...
      <div className="flex flex-wrap gap-5">
        {projects.map((project) => (
          <article
            key={project.title}
            className="min-w-[280px] flex-1 rounded-2xl border border-border/80 bg-card/72 p-6 md:basis-[calc(50%-0.625rem)]"
          >
            <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
              <div>
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="group inline-flex items-center gap-2 text-2xl font-semibold text-foreground"
                >
